    ...
    swal.fire({
        ...
        function (isConfirm) {
            if (isConfirm.value == true) {
                ajaxRequest({ url: "/Services/ServiceItemQuotation/Delete", type: 'POST', data: { ID: id }, callBack: deleteRecordCallBack });
            } else {
...
function modifyRecord(id, index) {
    redirectToAction("/Services/ServiceItemQuotation/Update?ID=", id, null);
}